# the code for the werko demo, lazer focused on it looking as good as possible
...
@cache
def get_sat_img_features() -> Dict[float, dict]:
    """
    ...
    for image_file in sorted(image_files):
        ...
        try:
            features = load_features_from_folder(rotated_sat_dir, filename_prefix, device='cpu')
